...
export const projectData = [
  { 
    ...
    contribute: "60%",
    deploy: "Github",
    detail: "HTML, CSS, JavaScript를 활용한 react 프로젝트로 사진 불러오기, 스티커나 테이프 요소들을 이용해 사용자가 캘린더를 커스텀하여 꾸미고 저장할 수 있게 제작하였습니다.",
  ...
  { 
    ...
    contribute: "100%",
    deploy: "Github",
    detail: "이 프로젝트는 포트폴리오 사이트입니다. Codepen을 이용하여 여러 애니메이션 효과를 적용하고 범위에 따라 마우스 커서의 이미지를 변경, EmailJS를 이용하여 사용자가 Contact에 입력하였을 때 이메일 계정과 연동하는 등의 많은 부분을 찾아 배울 수 있었습니다",
  ...
  { 
    ...
    contribute: "100%",
    deploy: "Dothome",
    detail: "HTML, CSS, JavaScript를 활용한 웹표준 프로젝트입니다.",
  ...
  { 
    ...
    date: "2025.04 ~ 2025.05",
    skill: " 마우스 하버 효과, 스크롤트리거, , 게시판, 파이어베이스를 이용한 데이터베이스, 카카오API 이용  ",
    language: "HTML, CSS, JAVA",
    contribute: "100%",
    deploy: "Firebase",
    detail: "슈퍼말차 사이트로 컨버스 사이트를 벤치마킹하여 리디자인하였습니다. 사용자가 회원가입, 로그인, 제품 위시리스트 저장, 장바구니 저장 등을 사용할 수 있고 게시판 기능을 활용하여 공지사항과 자주 묻는 질문을 만들었습니다. 또한 카카오API를 이용하여 지도를 불러와 실제 매장의 위치를 볼 수 있게 하였습니다.",
